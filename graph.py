...
#     q_index = state["current_q"]
#     audio_file = f"answer_{q_index+1}.wav"
#     record_audio(filename=audio_file, duration=30)
#     state["answer_file"] = audio_file
...
#     if not file_path:
#         print("⚠️ No audio recorded for this question, skipping transcription.")
#         return state
